...
| `delete_credentials_file` | Boolean | Delete the credentials file after the action is finished. If you want to keep the credentials file for a later step, set this to false.                       |
...
| `push`                    | String  | Whether to push the image to the registry.                                                                                                                    |
| `registry`                | String  | Google Artifact Registry to store docker images in.                                                                                                           |
| `repository_name`         | String  | Override the 'repo_name' used to construct the GAR repository name. Only necessary when the GAR includes a repo name that doesn't match the GitHub repo name. |
...
| `tags`                    | String  | List of Docker images to be pushed.                                                                                                                           |
