...
| `generate-summary`  | Boolean | `true`  | Generates a markdown job summary and sets the `OCI_MANIFEST_OUTPUT_JSON` env var with structured manifest data. Only runs when `push` is also `true`.               |
...
[
  {
    ...
    "manifests": [
      { "kind": "image", "platform": "linux/amd64", "digest": "sha256:def456..." },
      { "kind": "image", "platform": "linux/arm64", "digest": "sha256:ghi789..." },
      { "kind": "attestation", "digest": "sha256:jkl012...", "refersTo": "sha256:def456..." }
    ]
  }
]
```
